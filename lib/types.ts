...
export type Company = { id: string; name: string; uf: string | null; cnpj: string | null; head: boolean; legalName?:string; registrationSource?:{filename:string;sha256:string;line:number} };
